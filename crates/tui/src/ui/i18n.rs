...
fn localized_text(language: Language, key: &str) -> &'static str {
    if language == Language::ChineseSimplified {
        match key {
            ...
            "help.agents" => "切换到已有代理会话",
            "agents.title" => "代理",
            "agents.subtitle" => "选择已有代理会话",
            "agents.current" => "当前会话",
            "agents.working" => "工作中",
            "agents.idle" => "空闲",
            "agents.footer" => "↑/↓：选择  Enter：切换  Esc：取消",
...
fn english_text(key: &str) -> &'static str {
    match key {
        ...
        "help.agents" => "Switch to an existing agent session",
        "agents.title" => "Agents",
        "agents.subtitle" => "Choose an existing agent session",
        "agents.current" => "Current session",
        "agents.working" => "Working",
        "agents.idle" => "Idle",
        "agents.footer" => "↑/↓: Select  Enter: Switch  Esc: Cancel",
...
pub(crate) fn help_text() -> String {
    [
        ...
        format!("- `/agents`: {}", text("help.agents")),
