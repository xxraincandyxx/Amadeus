// @amadeus-header
// summary: Configuration models, defaults, merging, and hierarchical settings loading.
// layer: core
// status: active
// feature_flags: none
// provides:
// - type: crate::config::Config
// - type: crate::config::ConfigError
// - type: crate::config::Language
// - type: crate::config::PromptSettings
// - type: crate::config::Provider
// - type: crate::config::ToolOverrideConfig
// uses:
