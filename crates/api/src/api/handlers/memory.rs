...
use crate::api::types::{ErrorResponse, MemoryEntriesResponse, MemoryEntryInfo, MemoryProviderInfo, MemoryProvidersResponse};
...
pub async fn list_memory_providers<C: LLMClient + Clone + 'static>(
    ...
    registry.register(Arc::new(crate::context::memory_file::FileMemoryProvider::new(
